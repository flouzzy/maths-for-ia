...
- **[Jalon 140](jalon-140/Jalon%20140%20%28Classifieur%20de%20Bayes%20optimal%29.md)** : Classifieur de Bayes optimal, fonctions de perte de substitution (Surrogate losses) et consistance de la minimisation du risque empirique.
...
- **Dernier Jalon Enrichi** : [Jalon 139 - Stabilité Algorithmique](jalon-139/Jalon-139_Notion_de_stabilite_algorithmique.md) (Cours complet, 10 exercices avancés type ENS/Polytechnique, 5 TP d'implémentation de la stabilité uniforme et des bornes de généralisation).
