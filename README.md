...
- **[Jalon 140](jalon-140/Jalon%20140%20%28Classifieur%20de%20Bayes%20optimal%29.md)** : Classifieur de Bayes optimal, fonctions de perte de substitution (Surrogate losses) et consistance de la minimisation du risque empirique. 🔥 **Enrichi** *(10 Exos + 5 TP)*
...
- **Dernier Jalon Enrichi** : [Jalon 140 - Classifieur de Bayes optimal](jalon-140/Jalon%20140%20(Classifieur%20de%20Bayes%20optimal).md) (Cours complet, 10 exercices avancés, 5 TP d'implémentation).
- **Date de mise à jour** : 2026-06-04

- [2026-06-05] : Upsert du Jalon 140 - Classifieur de Bayes optimal. Status: Terminé.
