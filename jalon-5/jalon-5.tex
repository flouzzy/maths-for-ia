...
\(\star\)\(\star\)\(\star\)☆☆)}{Énoncé de l'Exercice (Difficulté : \textbackslash star\textbackslash star\textbackslash star☆☆)}}\label{uxe9noncuxe9-de-lexercice-difficultuxe9-starstarstar}
...
\textbf{Niveau de difficulté :} \(\star\)\(\star\)\(\star\)☆☆
...
\textbf{Niveau de difficulté :} \(\star\)\(\star\)\(\star\)\(\star\)☆
...
\item
  ...
  \item
    \textbf{Implication 2 (\(\impliedesup\)) :} S'il existe une
    application \(g: F \to E\) telle que \(g \circ f = \text{Id}_E\),
