# Exercice 9 - Difficulté : $\bigstar\bigstar\bigstar\bigstar\bigstar$

## Énoncé
Soit la matrice $A = \begin{pmatrix} 9 & 1 \\ 0 & 9 \end{pmatrix}$. Calculer l'exponentielle de matrice $e^{tA}$ et en déduire la solution du système différentiel associé $Y'(t) = A Y(t)$ avec condition initiale $Y(0) = \begin{pmatrix} 1 \\ 1 \end{pmatrix}$.
...
Posons $D = \begin{pmatrix} 9 & 0 \\ 0 & 9 \end{pmatrix} = 9 I_2$ et $N = \begin{pmatrix} 0 & 1 \\ 0 & 0 \end{pmatrix}$.
...
$$ e^{tD} = e^{9 t I_2} = \begin{pmatrix} e^{9t} & 0 \\ 0 & e^{9t} \end{pmatrix} = e^{9t} I_2 $$
...
$$ e^{tA} = (e^{9t} I_2) \begin{pmatrix} 1 & t \\ 0 & 1 \end{pmatrix} = \begin{pmatrix} e^{9t} & t e^{9t} \\ 0 & e^{9t} \end{pmatrix} $$

Pour trouver la solution du système $Y'(t) = A Y(t)$, on applique le théorème fondamental :
$$ Y(t) = e^{tA} Y(0) = \begin{pmatrix} e^{9t} & t e^{9t} \\ 0 & e^{9t} \end{pmatrix} \begin{pmatrix} 1 \\ 1 \end{pmatrix} = \begin{pmatrix} e^{9t} + t e^{9t} \\ e^{9t} \end{pmatrix} $$
