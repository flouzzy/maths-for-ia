# Exercice 2 - Difficulté : $\bigstar\star\star\star\star$

## Énoncé
Soit la matrice $A = \begin{pmatrix} 2 & 1 \\ 0 & 2 \end{pmatrix}$. Calculer l'exponentielle de matrice $e^{tA}$ et en déduire la solution du système différentiel associé $Y'(t) = A Y(t)$ avec condition initiale $Y(0) = \begin{pmatrix} 1 \\ 1 \end{pmatrix}$.
...
Posons $D = \begin{pmatrix} 2 & 0 \\ 0 & 2 \end{pmatrix} = 2 I_2$ et $N = \begin{pmatrix} 0 & 1 \\ 0 & 0 \end{pmatrix}$.
...
$$ e^{tD} = e^{2 t I_2} = \begin{pmatrix} e^{2t} & 0 \\ 0 & e^{2t} \end{pmatrix} = e^{2t} I_2 $$
...
$$ e^{tA} = (e^{2t} I_2) \begin{pmatrix} 1 & t \\ 0 & 1 \end{pmatrix} = \begin{pmatrix} e^{2t} & t e^{2t} \\ 0 & e^{2t} \end{pmatrix} $$

Pour trouver la solution du système $Y'(t) = A Y(t)$, on applique le théorème fondamental :
$$ Y(t) = e^{tA} Y(0) = \begin{pmatrix} e^{2t} & t e^{2t} \\ 0 & e^{2t} \end{pmatrix} \begin{pmatrix} 1 \\ 1 \end{pmatrix} = \begin{pmatrix} e^{2t} + t e^{2t} \\ e^{2t} \end{pmatrix} $$
