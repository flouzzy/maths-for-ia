# Exercice 3 : Équations Différentielles ($\bigstar$$\bigstar$$\star$$\star$$\star$)

## Problème

Résoudre rigoureusement l'équation différentielle suivante, définie sur $\mathbb{R}$ :
$$1y''(t) + 0y'(t) + 9y(t) = 3 \cos(2t)$$
...
2. **Recherche de la solution particulière :**
   Second membre $d(t) = 3 \cos(2t)$. Puisque $2i$ n'est pas racine, on cherche $y_P(t) = A \cos(2t)$.
   Dérivées : $y_P'(t) = -2A \sin(2t)$ et $y_P''(t) = -4A \cos(2t)$.
   Injection dans l'équation : $-4A \cos(2t) + 9A \cos(2t) = 5A \cos(2t) = 3 \cos(2t)$.
   Par identification : $5A = 3 \implies A = \frac{3}{5}$.
   Solution particulière : $y_P(t) = \frac{3}{5} \cos(2t)$.

3. **Solution générale complète :**
   $y(t) = \lambda_1 \cos(3t) + \lambda_2 \sin(3t) + \frac{3}{5} \cos(2t)$.
