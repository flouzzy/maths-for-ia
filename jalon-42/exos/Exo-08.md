# Exercice 8 : Équations Différentielles ($\bigstar$$\bigstar$$\bigstar$$\bigstar$$\star$)
...
2. **Recherche de la solution particulière :**
   Second membre $d(t) = 8 t$. On cherche $y_P(t) = A t + B$.
   Dérivées : $y_P'(t) = A$ et $y_P''(t) = 0$.
   Injection dans l'équation : $0 - 4A + 4(At + B) = 8 t$.
   $4At + (4B - 4A) = 8 t$.
   Par identification : $4A = 8 \implies A = \frac{8}{4}$.
   Et $4B - 4A = 0 \implies B = A = \frac{8}{4}$.
   Solution particulière : $y_P(t) = \frac{8}{4} t + \frac{8}{4}$.

3. **Solution générale complète :**
   $y(t) = (\lambda_1 + \lambda_2 t) e^{2t} + \frac{8}{4} t + \frac{8}{4}$.
