...
Données spécifiques pour l'exercice 10 (niveau de difficulté 5) :
Soit A = \frac{1}{\sqrt{2}} \begin{pmatrix} 1 & 1 \\ -1 & 1 \end{pmatrix} \begin{pmatrix} 5 & 0 \\ 0 & 0 \end{pmatrix} \begin{pmatrix} \cos(\theta) & \sin(\theta) \\ -\sin(\theta) & \cos(\theta) \end{pmatrix}^T.
Indice : Reconnaissance directe d'une SVD paramétrée. Compression ultime.
