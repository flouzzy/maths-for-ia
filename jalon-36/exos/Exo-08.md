...
Données spécifiques pour l'exercice 8 (niveau de difficulté 4) :
Soit A = \begin{pmatrix} 3 & 0 & 0 \\ 0 & -2 & 0 \\ 0 & 0 & 0 \end{pmatrix}.
Indice : Matrice carrée 3x3 diagonale avec valeurs singulières nulles et négatives.
