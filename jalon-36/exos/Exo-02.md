...
Données spécifiques pour l'exercice 2 (niveau de difficulté 1) :
Soit A = \begin{pmatrix} 0 & 3 \\ 4 & 0 \end{pmatrix}.
Indice : Matrice anti-diagonale, 2x2. Permutation requise pour SVD.
