...
Données spécifiques pour l'exercice 5 (niveau de difficulté 3) :
Soit A = \begin{pmatrix} 1 & 1 \\ 0 & 1 \\ -1 & 1 \end{pmatrix}.
Indice : Matrice rectangulaire 3x2. Full column rank.
