...
Données spécifiques pour l'exercice 4 (niveau de difficulté 2) :
Soit A = \begin{pmatrix} 1 & 2 \\ 2 & 4 \end{pmatrix}.
Indice : Matrice symétrique de rang 1, 2x2. Une valeur singulière nulle.
