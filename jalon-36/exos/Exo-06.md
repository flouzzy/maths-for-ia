...
Données spécifiques pour l'exercice 6 (niveau de difficulté 3) :
Soit A = \begin{pmatrix} 1 & 0 & -1 \\ 1 & 1 & 1 \end{pmatrix}.
Indice : Matrice rectangulaire 2x3. Full row rank (transposée de la précédente).
