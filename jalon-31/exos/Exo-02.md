...
Soit $E$ un $\mathbb{K}$-espace vectoriel de dimension $n$. Considérons la propriété $P_2$ relative aux opérateurs nilpotents et aux matrices de Jordan.
Démontrez de manière exhaustive, avec Zéro Ellipse, les implications algébriques de la réduction de Jordan sur la dynamique d'un système discret modélisé par une telle matrice, en particulier lorsque $k = 2$.
