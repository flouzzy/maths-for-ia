...
1.  **$y \neq x$ :**
    Puisque $y = x+1$ et $1 > 0$, il s'ensuit par simple addition algébrique que $y > x$, ce qui implique rigoureusement que $y \neq x$. Cette condition est satisfaite.
...
2.  **$z \in [0,1]$ :**
    ...
    Puisque $0 < \frac{y}{2} \le \frac{1}{2}$ et sachant que $\frac{1}{2} < 1$, nous déduisons par transitivité des inégalités strictes et larges que $0 \le \frac{y}{2} \le 1$, prouvant ainsi explicitement que $\frac{y}{2}$ appartient à l'intervalle $[0,1]$.
