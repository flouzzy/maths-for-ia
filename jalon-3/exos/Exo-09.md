...
Démontrons formellement la propriété pour les cas restants afin d'épuiser l'ensemble $E$ sans recours à une symétrie implicite :
*   Si $x=2$, nous définissons explicitement le choix $y=3$.
