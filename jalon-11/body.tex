\hypertarget{jalon-11-formes-linuxe9aires-hyperplans-espace-dual-et-orthogonalituxe9-en-dimension-finie}{%
\section{Jalon 11 : Formes linéaires, hyperplans, espace dual et
orthogonalité en dimension
finie}\label{jalon-11-formes-linuxe9aires-hyperplans-espace-dual-et-orthogonalituxe9-en-dimension-finie}}
...
\hypertarget{a.-anatomie-et-typage-chirurgical}{%
\subsubsection{A. Anatomie et Typage
Chirurgical}\label{a.-anatomie-et-typage-chirurgical}}
...
\hypertarget{b.-thuxe9oruxe8mes-fondamentaux}{%
\subsubsection{B. Théorèmes
Fondamentaux}\label{b.-thuxe9oruxe8mes-fondamentaux}}
...
\hypertarget{exercices-dapplication-1}{%
\section{Exercices d'Application}\label{exercices-dapplication-1}}

\hypertarget{exercice-1-espace-dual-en-dimension-2}{%
\section{Exercice 1: Espace dual en dimension
2}\label{exercice-1-espace-dual-en-dimension-2}}
...
\hypertarget{travaux-pratiques-et-simulations-algorithmiques}{%
\section{Travaux Pratiques et Simulations
Algorithmiques}\label{travaux-pratiques-et-simulations-algorithmiques}}

\hypertarget{tp-1-impluxe9mentation-pure-python-dune-forme-linuxe9aire}{%
\section{TP 1: Implémentation pure Python d'une forme
linéaire}\label{tp-1-impluxe9mentation-pure-python-dune-forme-linuxe9aire}}
...
\hypertarget{validation-rigoureuse}{%
\subsection{Validation Rigoureuse}\label{validation-rigoureuse}}
...
\hypertarget{objectif-mathuxe9matique-1}{%
\subsection{Objectif mathématique}\label{objectif-mathuxe9matique-1}}

Mise en pratique algorithmique de l'espace dual, de l'hyperplan et des
notions fondamentales de l'algèbre linéaire, structurée en Python absolu
sans bibliothèques de haut niveau.

\hypertarget{code-python-1}{%
\subsection{Code Python}\label{code-python-1}}
...
\hypertarget{validation-rigoureuse-1}{%
\subsection{Validation Rigoureuse}\label{validation-rigoureuse-1}}
...
\hypertarget{objectif-mathuxe9matique-2}{%
\subsection{Objectif mathématique}\label{objectif-mathuxe9matique-2}}

Mise en pratique algorithmique de l'espace dual, de l'hyperplan et des
notions fondamentales de l'algèbre linéaire, structurée en Python absolu
sans bibliothèques de haut niveau.

\hypertarget{code-python-2}{%
\subsection{Code Python}\label{code-python-2}}
...
\hypertarget{validation-rigoureuse-2}{%
\subsection{Validation Rigoureuse}\label{validation-rigoureuse-2}}
...
\hypertarget{objectif-mathuxe9matique-3}{%
\subsection{Objectif mathématique}\label{objectif-mathuxe9matique-3}}

Mise en pratique algorithmique de l'espace dual, de l'hyperplan et des
notions fondamentales de l'algèbre linéaire, structurée en Python absolu
sans bibliothèques de haut niveau.

\hypertarget{code-python-3}{%
\subsection{Code Python}\label{code-python-3}}
...
\hypertarget{validation-rigoureuse-3}{%
\subsection{Validation Rigoureuse}\label{validation-rigoureuse-3}}
...
\hypertarget{objectif-mathuxe9matique-4}{%
\subsection{Objectif mathématique}\label{objectif-mathuxe9matique-4}}

Mise en pratique algorithmique de l'espace dual, de l'hyperplan et des
notions fondamentales de l'algèbre linéaire, structurée en Python absolu
sans bibliothèques de haut niveau.

\hypertarget{code-python-4}{%
\subsection{Code Python}\label{code-python-4}}
...
\hypertarget{validation-rigoureuse-4}{%
\subsection{Validation Rigoureuse}\label{validation-rigoureuse-4}}
