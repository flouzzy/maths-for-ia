...
* de $S$ si et seulement si pour tout $s \in S$, $s \le M$.

* de $S$ si et seulement si pour tout $s \in S$, $s \ge m$.

* de $S$, notée $\sup S$, est le plus petit des majorants de $S$. Formellement, $s_0 = \sup S$ si et seulement si :
...
* de $S$, notée $\inf S$, est le plus grand des minorants de $S$. Formellement, $i_0 = \inf S$ si et seulement si :
