...
1.
Emboîtement
 : Pour tout entier naturel $n \in \mathbb{N}$, l'intervalle $I_{n+1}$ est inclus dans l'intervalle $I_n$. Formellement, $\forall n \in \mathbb{N}, [a_{n+1}, b_{n+1}] \subseteq [a_n, b_n]$.
2.
Longueurs tendant vers zéro
 : La longueur des intervalles tend vers zéro lorsque $n$ tend vers l'infini. Formellement, $\lim_{n \to \infty} (b_n - a_n) = 0$.
