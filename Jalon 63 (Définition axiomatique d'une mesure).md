...
## Description
Définition axiomatique d'une mesure, mesures finies, $\sigma$-finies et propriétés de continuité monotone.

\n**Concepts liés** : [[Jalon 63 (Définition axiomatique d'une mesure)]]\n---
**Précédent** : [[Jalon 62 (Algèbres)]] | **Suivant** : [[Jalon 64 (Construction pas à pas de la mesure de Lebesgue sur $-mathbb{R}$ via la mesure extérieure.)]]
