...
\begin{tikzpicture}[scale=1.5]
    \draw[->, gray!50] (-1,0) -- (4,0) node[right] {$x$};
    \draw[->, gray!50] (0,-1) -- (0,3) node[above] {$y$};
    \draw[->, thick, blue] (0,0) -- (3,1) node[midway, above left] {$\vec{u}$};
    \draw[->, thick, red] (0,0) -- (2,2) node[midway, above left] {$\vec{v}$};
    \draw[dashed, gray] (2,2) -- (1.8, 0.6);
    \draw[->, thick, purple] (0,0) -- (1.8,0.6) node[midway, below right] {$\text{proj}_{\vec{u}}(\vec{v})$};
    \draw (1.8,0.6) -- (1.7, 0.9) -- (1.9, 1.0);
\end{tikzpicture}
\caption{Projection orthogonale illustrant géométriquement le produit scalaire.}
\end{figure}
...
\section{L'Inégalité Fondamentale de Cauchy-Schwarz}
...
\textbf{Définition (Forme bilinéaire) :}
...
\textbf{Définition (Forme symétrique et antisymétrique) :}
...
\textbf{Définition (Forme sesquilinéaire) :}
...
\textbf{Définition (Forme hermitienne) :}
...
\#
\section{L'Inégalité Triangulaire (Minkowski)}
...
\subsection*{Énoncé Formel et Typage Rigoureux}
...
\subsection*{Preuve Analytique Pas-à-Pas}
La démarche déductive exige une formalisation intégrale sans ellipse.
1. \textbf{Développement de la norme au carré :}
...
\subsection*{Preuve Analytique Pas-à-Pas}
La démarche déductive exige une formalisation intégrale sans ellipse.
\textbf{1. Cas Réel ($\mathbb{K} = \mathbb{R}$)}
...
\subsection*{Preuve Analytique Pas-à-Pas}
La démarche déductive exige une formalisation intégrale sans ellipse.
\textbf{1. Démonstration du produit scalaire :}
...
\subsection*{Preuve Analytique Pas-à-Pas}
La démarche déductive exige une formalisation intégrale sans ellipse.
\textbf{1. Inégalité sur sommes finies :}
...
\subsection*{Preuve Analytique Pas-à-Pas}
La démarche déductive exige une formalisation intégrale sans ellipse.
\textbf{1. Validation du produit scalaire :}
...
\subsection*{Preuve Analytique Pas-à-Pas}
La démarche déductive exige une formalisation intégrale sans ellipse.
\textbf{1. Borne via Cauchy-Schwarz :}
...
\subsection*{Preuve Analytique Pas-à-Pas}
La démarche déductive exige une formalisation intégrale sans ellipse.
\textbf{1. Symétrie de la matrice :}
...
\textbf{Règle stricte :} Code Python pur, aucune bibliothèque externe (ni numpy, ni math) hormis l'opération `** 0.5` pour la racine carrée.
