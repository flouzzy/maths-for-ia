---
uuid: jalon-48-tp-02
title: "TP 2 : Implémentation from scratch de la Rétropropagation (Variante 2)"
---
# TP 2 : Rétropropagation Numpy - Architecture 2 $\bigstar$$\bigstar$$\bigstar$$\star$$\star$
...
# Test d'intégrité avec l'architecture spécifique au TP 2
# On utilise 4 couches cachées pour vérifier la propagation sur une plus grande profondeur
