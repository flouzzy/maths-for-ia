---
uuid: jalon-48-tp-04
title: "TP 4 : Implémentation from scratch de la Rétropropagation (Variante 4)"
---
# TP 4 : Rétropropagation Numpy - Architecture 4 $\bigstar$$\bigstar$$\star$$\star$$\star$
...
# Test d'intégrité avec l'architecture spécifique au TP 4
# On utilise 6 couches cachées pour vérifier la propagation sur une plus grande profondeur
