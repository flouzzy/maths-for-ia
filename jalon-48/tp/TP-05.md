---
uuid: jalon-48-tp-05
title: "TP 5 : Implémentation from scratch de la Rétropropagation (Variante 5)"
---
# TP 5 : Rétropropagation Numpy - Architecture 5 $\bigstar$$\bigstar$$\bigstar$$\star$$\star$
...
# Test d'intégrité avec l'architecture spécifique au TP 5
# On utilise 7 couches cachées pour vérifier la propagation sur une plus grande profondeur
