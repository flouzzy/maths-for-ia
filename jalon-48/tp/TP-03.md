---
uuid: jalon-48-tp-03
title: "TP 3 : Implémentation from scratch de la Rétropropagation (Variante 3)"
---
# TP 3 : Rétropropagation Numpy - Architecture 3 $\bigstar$$\star$$\star$$\star$$\star$
...
# Test d'intégrité avec l'architecture spécifique au TP 3
# On utilise 5 couches cachées pour vérifier la propagation sur une plus grande profondeur
